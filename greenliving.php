...
<div class="project-section">
	<div class="fixed-section" style="background-image: url('../images/greenliving.jpg');">
	...
	<div class="fixed-section right right-content">
		<div class="section-heading">
			<h2 class="margin-top120" style="color: #55A43D;">GREEN LIVING</h2>
		</div>
		<div class="margin-top30 secondary-title">
			<p class="margin-bottom40">Green living aims to raise awareness about environmental issues and inspire people to live and act more sustainably.</p>
		</div>
