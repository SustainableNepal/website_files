            ...
            <div class="home-content">
                <div class="container">
                    ...
                    <div class="main-flex-slider wow fadeIn" data-wow-delay="400ms">
                        <h1 class="rotate">Environmental, Economic, Social</h1>
                        <h1>Sustainability</h1>
                    </div> 
                    <h2 class="slide-btm-text wow fadeIn" data-wow-delay="600ms">For a green future in nepal</h2>
                    <div class="text-center">
                        <a id="about-scroll" href="#about" class="btn btn-default scrollto wow animated fadeInUp"  data-wow-delay="600ms">Get Started<span class="icon-down" style="margin-left: 10px;"></span></a>
                    </div>
                </div>
            </div>
        </div>
